Feature:
    ...
    Scenario: should insert into incidents via pullrequest
        ...
        When I execute query "SELECT * FROM `$PROJECT_ID.itsubaki_q._incidents_via_pullreqs` WHERE date = \"2021-07-30\" LIMIT 1"
    ...
    Scenario: should insert into incidents via commit
        ...
        When I execute query "SELECT * FROM `$PROJECT_ID.itsubaki_q._incidents_via_commits` WHERE date = \"2021-12-26\" LIMIT 1"
        Then I get the following result:
